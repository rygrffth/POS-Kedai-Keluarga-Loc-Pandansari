...
type Tab = "transactions" | "tables" | "closing" | "inventory" | "expenses" | "history" | "analytics" | "database" | "settings";
      ...
      <ScalingContainer bg="bg-slate-900" baseWidth={1280} baseHeight={800} mode="width">
        <main className="h-full bg-slate-900 flex items-center justify-center p-4">
          <div className="bg-white p-8 rounded-3xl shadow-2xl max-w-sm w-full animate-in zoom-in-95 duration-300">
            <div onClick={handleSecretGateway} className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4 cursor-pointer hover:bg-blue-200 transition-all"><Lock size={32} className="text-blue-600" /></div>
            <h2 onClick={handleSecretGateway} className="text-2xl font-black text-center text-slate-800 mb-2 cursor-pointer hover:text-blue-600 transition-colors">POS Login</h2>
    ...
    <ScalingContainer bg="bg-gray-50" baseWidth={1280} baseHeight={1000} mode="width">
      ...
      <div className="sticky top-0 z-20 no-print">
        <div className="bg-slate-900 text-white p-5 shadow-lg border-b border-slate-800 flex justify-between items-center w-full">
          <h1 onClick={handleSecretGateway} className="text-xl font-black tracking-tight flex items-center gap-2 cursor-pointer hover:opacity-80 transition-opacity">
